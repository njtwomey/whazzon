# Harvest report — bristol-uk, 2026-08-16
...
`data/bristol-uk/catalogue/*.yaml`, then re-run `npm run check-urls`.
...
- No `404.html`, so a direct hit on `/bristol-uk/theatre` 404s on GitHub Pages
